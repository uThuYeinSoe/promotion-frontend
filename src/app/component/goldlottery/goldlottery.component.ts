...
@Component({
  selector: 'app-goldlottery',
  imports: [CommonModule],
  templateUrl: './goldlottery.component.html',
  styleUrl: './goldlottery.component.scss',
  standalone: true,
})
export class GoldlotteryComponent implements OnInit {
  ...
  async ngOnInit() {
    const resObj = await firstValueFrom(
      this.agentLotteryControlService.checkStatusLotteryByGame('0400')
    );
    console.log(resObj);
